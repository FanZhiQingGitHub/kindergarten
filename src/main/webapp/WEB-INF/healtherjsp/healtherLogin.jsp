...
<form class="layui-form" method="post">
        ...
        <div class="container">
            ...
            <div class="main_right">
                ...
                <div class="main_r_up">
                    ...
                    <div class="pp"><img src="${pageContext.request.contextPath}/image/loginreg/healtherLogin.png"
    ...
    <div id="type-content" style="display: none;">
        <div class="layui-form-item" style="margin-left: 35px;">
            ...
            <div class="layui-inline">
                <input type="text" id="healtherphone" placeholder="请输入11位手机号码"
                       autocomplete="off" class="layui-input" style="width: 325px;margin-top: 6%">
            </div>
        </div>
    </div>
    ...
    layui.use(['form', 'layer', 'jquery', 'layedit', 'laydate'], function () {
        ...
        $(function () {
            $("#code").click(function () {
                ...
                var healthername = $("#healthername").val();
                $.ajax({
                    url: path + '/healther/findExistHealtherName',
                    async: true,
                    type: 'post',
                    data: {
                        "healthername": healthername
