...
<div class="demoTable">
	...
	消息内容：
	<div class="layui-inline selects">
		<input class="layui-input" name="clamsgdetail" id="clamsgdetail" autocomplete="off">
	</div>
...
<script>
	layui.use(['table', 'layer', 'form'], function () {
		...
		table.render({
			...
			, url: src + '/teacher/classMessage' //数据接口
			, page: true //开启分页
			, id: 'demotable'//当对应的进行条件查询的时候
			, cellMinWidth: 50 //全局定义常规单元格的最小宽度，layui 2.2.1 新增
			, cols: [[ //表头
				{field: 'clamsgid', title: '消息编号', sort: true, align: 'center', width: 120}
				, {field: 'clamsgdetail', title: '消息通知内容', align: 'center', width: 400}
				, {
					field: 'sendmsgtime', title: '推送时间', align: 'center', width: 180,
