...
<body>
<h1 style="text-align:center;font-size: 40px;color: #009688">校园通知</h1>
<form class="layui-form" action="#" lay-filter="test1">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<textarea name="infotypename" id="infotypename" autocomplete="off" placeholder="请输入内容"
...
<script>
	layui.use(['jquery','layer'], function () {
		...
		$(function () {
			$("#save").click(function () {
				layer.confirm('园长您确定编辑好-消息通知吗?', {icon: 3, title: '温馨提示'}, function (index) {
					var infotypename = $("#infotypename").val();
					var kindername = $("#kindername").val();
					$.ajax({
						url: path + "/director/addInfoType",
						async: true,
						type: "post",
						data: {"infotypename": infotypename,"kindername":kindername},
						datatype: "text",
						success: function (msg) {
							if (msg == "success") {
								layer.alert("添加消息成功！", {icon: 6}, function (index) {
									window.location.href = path+"/director/toUrl/directorMain";
								});
							} else {
