	...
	<div class="layui-form-item layui-form-text">
		...
		<div class="layui-input-inline">
			<div class="layui-form" lay-filter="myDiv">
				<input type="text" class="layui-input" name="parentAge" placeholder="请输入年龄" id="parentAge" autocomplete="off">
			</div>
		</div>
	</div>
	<div class="layui-form-item layui-form-text">
		...
		<div class="layui-input-inline">
			<div class="layui-form" lay-filter="myDiv">
				<input type="text" class="layui-input" name="parentAdd" placeholder="请输入地址" id="parentAdd" autocomplete="off">
			</div>
		</div>
	</div>
	<div class="layui-form-item layui-form-text">
		...
		<div class="layui-input-inline">
			<div class="layui-form" lay-filter="myDiv">
				<input type="text" class="layui-input" name="parentPhone" placeholder="请输入联系方式" id="parentPhone" autocomplete="off">
			</div>
		</div>
	</div>
	<div class="layui-form-item layui-form-text">
		...
		<div class="layui-input-inline">
			<div class="layui-form" lay-filter="myDiv">
				<input type="text" class="layui-input" name="parentJob" id="parentJob" placeholder="请输入职业" autocomplete="off">
			</div>
		</div>
	</div>
</form>
