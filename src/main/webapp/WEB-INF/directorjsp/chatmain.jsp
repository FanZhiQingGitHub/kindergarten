...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#exitBtn").on("click",function(){
			closeWebsocket();
			location.href="${pageContext.request.contextPath}/director/toUrl/chatlogin";
		});
...
<!--聊天区域结束-->
<div class="footer">
	<p>版权所有 2006 - 2016  xxxxxxxxxxxxxxxxxxx   邮编：100096<br />
电话：xxxxxxxxxxxxxx   邮箱: xxxxxxxxxxxx   京ICP备08001421号   xxxxxxxxxxxxx</p>
</div>
</body>
</html>
